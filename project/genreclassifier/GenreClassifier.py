...
if __name__ == "__main__":
    ...
    learning_rate = 0.001
    batch_size = 100
    num_steps = 6000 / batch_size    # Size of data set
    display_step = 100
    ...
    test_iterator = tf.data.Iterator.from_structure(batch_test_data_set.output_types, batch_test_data_set.output_shapes)
    test_iterator_init_op = test_iterator.make_initializer(batch_test_data_set)
